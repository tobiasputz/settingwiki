const STATIC='seeker-static-v7320';
const PRIVATE='seeker-private-v7320';
const META='seeker-offline-meta-v7320';
const ENABLE_KEY='/__seeker_offline_enabled__';
const SHELL=['/static/wiki.css?v=7320','/static/wiki.js?v=7320','/static/tour.css?v=7320','/static/tour.js?v=7320','/static/refinement.css?v=7320','/static/seeker-icon.svg','/static/icon-192.png','/static/icon-512.png','/static/v7.css?v=7320','/static/v7-player.js?v=7320','/static/homebrew.css?v=7320','/static/homebrew.js?v=7320','/static/homebrew-source.js?v=7320'];
const privatePage=u=>u.pathname==='/'||['/session','/timeline','/calendar','/mysteries','/handouts','/updates','/network','/characters','/campaign','/structures','/archive','/schedule','/tables','/investigation','/recap','/app','/homebrew'].includes(u.pathname)||u.pathname.startsWith('/wiki/')||u.pathname.startsWith('/homebrew/source/')||u.pathname.startsWith('/atlas/')||u.pathname.startsWith('/handout/')||u.pathname.startsWith('/characters/');
